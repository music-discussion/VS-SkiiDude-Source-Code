...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		/*var snowFX = new FlxUICheckBox(10, 165, null, null, "SnowFX", 100);
		snowFX.checked = (_song.snowSFX == 1);
		snowFX.callback = function()
		{
			_song.snowSFX = 0;
			if (snowFX.checked)
			{
			...
			trace('just activate the sfx'); // all this stuff did not work sad
		};*/
	//	snowSFX = _song.snowSFX;
