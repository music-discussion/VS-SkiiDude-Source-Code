...
class SnowFXOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.snowSFX = !FlxG.save.data.snowSFX;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Snow SFX: " + (!FlxG.save.data.snowSFX ? "off" : "on");
	}
}

class RealisticOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.realistic = !FlxG.save.data.realistic;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Realistic Mode (RTX): " + (!FlxG.save.data.realistic ? "coming soon" : "coming soon");
	}
}
